...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, LED4_Pin|UART4_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SW_OK_Pin SW_CAL_Pin PE7 PE8
                           COLL_LDL_RET_Pin COLL_LDL_EXT_Pin COLL_LDL_RIGHT_Pin COLL_LDL_LEFT_Pin
                           COLL_TRIM_DOWN_Pin COLL_TRIM_UP_Pin COLL_TRIM_RIGHT_Pin */
  GPIO_InitStruct.Pin = SW_OK_Pin|SW_CAL_Pin|GPIO_PIN_7|GPIO_PIN_8
                          |COLL_LDL_RET_Pin|COLL_LDL_EXT_Pin|COLL_LDL_RIGHT_Pin|COLL_LDL_LEFT_Pin
                          |COLL_TRIM_DOWN_Pin|COLL_TRIM_UP_Pin|COLL_TRIM_RIGHT_Pin;
  ...
  /*Configure GPIO pins : COLL_TQ_LIM_Pin COLL_CDR_Pin COLL_GRIP_2_Pin COLL_GRIP_1_Pin */
  GPIO_InitStruct.Pin = COLL_TQ_LIM_Pin|COLL_CDR_Pin|COLL_GRIP_2_Pin|COLL_GRIP_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
